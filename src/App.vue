<template>
  <div>
    ...
    <main class="scroll-smooth">
      ...
      <section id="bio" class="flex w-full min-h-screen p-8 bg-sky-50">
            ...
            <div class="flex items-center justify-between w-full" v-show="locale === 'en'">
              ...
              <div class="flex items-center justify-center mt-28 cursor-default">
                <div class="space-y-2 animate-fade-up animate-once animate-ease-in-out">
                  ...
                  <div class="flex font-IrBold text-4xl gap-x-2">
                    <span class="text-sky-600 text-shadow-md">Engineer</span>
                    <span class="text-shadow-md">&</span>
                    <span class="text-teal-600 text-shadow-md">manager</span>
                    <span class="text-shadow-md">in industrial units</span>
                  </div>
      ...
      L341.91,330.654L341.91,330.654z"/>
            ...
            <div class="flex items-center justify-between w-full" dir="rtl" v-show="locale === 'fa'">
              ...
              <!--Text-->
              <div class="mt-24 mr-2 cursor-default">
                <div class="space-y-3 animate-fade-up animate-once animate-ease-in-out">
                  ...
                  <div class="flex font-IrBold text-4xl gap-x-3 tracking-widest">
                    <span class="text-sky-600 text-shadow-md">مهندس</span>
                    <span class="text-shadow-md">و</span>
                    <span class="text-teal-600 text-shadow-md">مدیر</span>
                    <span class="text-shadow-md">در واحد های صنعتی</span>
                  </div>
...
فارغ‌التحصیل مهندسی شیمی با مدرک مدیریت از دانشگاه تهران، متمرکز بر نوآوری و بهبود عملیاتی در صنعت و فناوری. دارای تجربه در مدیریت پروژه‌های پیچیده، بهینه‌سازی فرآیندها، و ارائه راه‌حل‌های پایدار برای ارتقاء کیفیت و بهره‌وری. مسلط به هدایت تیم‌های چندرشته‌ای، تحقیق و توسعه، تضمین کیفیت، و توسعه راهبردی کسب‌وکار. نتیجه‌گرا و متعهد به خلق ارزش از طریق نوآوری صنعتی و فناورانه.                  </span>
      ...
      L341.91,330.654L341.91,330.654z"/>
          ...
          <div :class="locale === 'fa' ? 'align-right' : 'align-left'" ref="emblaRef" class="embla w-[540px] overflow-hidden">
            <div class="flex filter grayscale">
      ...
      <section id="experience" class="min-h-screen p-8 bg-white cursor-default">
...
مستندسازی و گزارش‌دهی</span>
      ...
      <section id="education" class="min-h-screen p-8 bg-gray-200 cursor-default">
      ...
      <section id="certification" class="min-h-screen p-8 bg-sky-100 cursor-default">
      ...
      <section id="contact" class="min-h-screen relative p-8 bg-gray-100 cursor-default">
